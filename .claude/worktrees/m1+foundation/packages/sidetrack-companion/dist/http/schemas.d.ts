...
export declare const workstreamTrustPutSchema: z.ZodObject<{
    allowedTools: z.ZodArray<z.ZodEnum<{
        "bac.move_item": "bac.move_item";
        "bac.queue_item": "bac.queue_item";
        "bac.bump_workstream": "bac.bump_workstream";
        "bac.archive_thread": "bac.archive_thread";
        "bac.unarchive_thread": "bac.unarchive_thread";
    }>>;
}, z.core.$strip>;
