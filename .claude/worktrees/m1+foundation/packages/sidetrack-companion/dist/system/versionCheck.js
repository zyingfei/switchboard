...
// path lightweight.
export const isBehind = (current, latest) => {
...
export const clearVersionCheckCache = () => {
    cache = undefined;
};
export const checkLatestVersion = async (currentVersion, fetchPort = globalThis.fetch, now = new Date()) => {
