...
export const registerSessionTools = (server, companionClient) => {
    server.registerTool('sidetrack.session.attach', {
        ...
        inputSchema: {
            ...
            tool: sessionToolSchema.describe("Which agent runtime is calling: 'claude_code', 'codex', 'cursor', or 'other'."),
        ...
        if (companionClient === undefined) {
            throw new Error('sidetrack-mcp was started without --companion-url / --bridge-key; sidetrack.session.attach is unavailable.');
        }
