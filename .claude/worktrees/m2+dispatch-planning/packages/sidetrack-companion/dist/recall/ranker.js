...
export const buildLexicalIndex = (items) => {
...
const buildSnippet = (text, query, maxChars = 220) => {
...
export const rankHybrid = (queryText, queryEmbedding, items, now, opts) => {
