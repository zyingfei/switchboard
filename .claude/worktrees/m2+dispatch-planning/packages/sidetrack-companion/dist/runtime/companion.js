...
import { acquireRecallProcessLock, cleanupOrphanIndexTmpFiles, } from '../recall/recovery.js';
...
import { createRelayTransport, getRelayTransportStatus, stopRelayTransport, } from '../sync/relayTransport.js';
...
export const startCompanion = async (options) => {
    ...
    try {
        ...
        const recallLock = await acquireRecallProcessLock(options.vaultPath);
        ...
        syncContractRunner.register(createProjectionMaterializer({
        ...
        syncContractRunner.register(createExtractionMaterializer({
        ...
        syncContractRunner.register(createConnectionsMaterializer({
            vaultRoot: options.vaultPath,
            eventLog: baseEventLog,
            timelineStore,
        ...
        const onLocalAccepted = (accepted) => {
        ...
        // worker (gate L1-G6).
        syncContractRunner.register(createRecallMaterializer({
            recallLifecycle,
            recallActivity,
            eventLog: baseEventLog,
            ...
            ...(options.relay === undefined
                ...
                : {
                    sync: {
                        ...
                        getRelayStatus: () => relayTransport === null ? null : getRelayTransportStatus(relayTransport),
                    },
                }),
        ...
        return {
            ...
            close: async () => {
                ...
                if (relayTransport !== null)
                    stopRelayTransport(relayTransport);
                await watcher?.close();
                await started.close();
