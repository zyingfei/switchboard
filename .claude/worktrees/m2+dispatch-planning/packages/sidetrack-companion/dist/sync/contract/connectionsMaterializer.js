...
import { buildConnectionsSnapshot, } from '../../connections/snapshot.js';
import { buildDayProjection, collectTimelinePayloads, groupByDay, } from '../../timeline/projection.js';
...
export const createConnectionsMaterializer = (deps) => {
    let pending = false;
    let running = false;
    let dirty = false;
    ...
    const buildTimelineDays = (merged) => {
...
//# sourceMappingURL=connectionsMaterializer.js.map