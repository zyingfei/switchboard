...
export const mcpAuthKeyPath = (vaultPath) => join(vaultPath, '_BAC', '.config', 'mcp-auth.key');
export const createMcpAuthKey = () => randomBytes(32).toString('base64url');
export const ensureMcpAuthKey = async (vaultPath) => {
...
//# sourceMappingURL=mcpAuthKey.js.map