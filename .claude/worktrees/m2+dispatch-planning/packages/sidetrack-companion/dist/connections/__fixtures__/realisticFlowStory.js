...
export const URL_A_GOOGLE_SEARCH = 'https://www.google.com/search?q=Linux+crypto+subsystem&newwindow=1&sca_esv=9700858d11d87a5f&sxsrf=ANbL-n7otDb8AtUZOxbzZ4JQi1ezOpsbrw';
...
export const URL_A_GITHUB_POC = 'https://github.com/theori-io/copy-fail-CVE-2026-31431/blob/main/copy_fail_exp.py';
...
export const URL_B_CHATGPT_1 = 'https://chatgpt.com/g/g-p-69ec077b42948191a1fd309d64a860ae-switchboard/c/69fd259a-83b0-8326-a4d9-c4c1b76a5986';
export const URL_B_CHATGPT_2 = 'https://chatgpt.com/g/g-p-69ec077b42948191a1fd309d64a860ae/c/69fcb926-3a98-8328-bbe4-baee4da7fbef';
...
const POC_CODE_SNIPPET = 'ssize_t copy_file_range(int fd_in, off_t *off_in, int fd_out, off_t *off_out, size_t len, unsigned int flags)';
...
const toAcceptedEvents = (raw) => {
    const sorted = [...raw].sort((a, b) => a.timeIso !== b.timeIso ? (a.timeIso < b.timeIso ? -1 : 1) : a.aggregateId < b.aggregateId ? -1 : 1);
...
// Public API
// ---------------------------------------------------------------------------
export const buildRealisticFlowFixture = () => ({
    events: buildEvents(),
    threads,
    workstreams,
    dispatches,
...
//# sourceMappingURL=realisticFlowStory.js.map