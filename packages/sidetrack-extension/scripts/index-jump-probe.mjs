...
console.log('before:', {
  entries: before.entryCount,
  eventTurns: before.eventTurnCount,
  drift: before.eventTurnCount - before.entryCount,
});
        ...
        turns: [
          {
            ordinal: 0,
            role: 'user',
            text: 'Probe turn one — first user message about caching.',
            capturedAt: new Date().toISOString(),
          },
          {
            ordinal: 1,
            role: 'assistant',
            text: 'Probe turn two — assistant response describing recall index drift fix.',
            capturedAt: new Date().toISOString(),
          },
          {
            ordinal: 2,
            role: 'user',
            text: 'Probe turn three — closing user follow-up about systematic review.',
            capturedAt: new Date().toISOString(),
          },
        ],
      },
...
console.log('after :', {
  entries: after.entryCount,
  eventTurns: after.eventTurnCount,
  drift: after.eventTurnCount - after.entryCount,
});
