...
// Toolbar overflow ("⋯") menu. R1.2 (user feedback 2): this menu now
// holds ONLY the three DIAGNOSTICS — Capture health, Dump panel state,
// Design preview. Progressive disclosure hides diagnostics, not daily
// tools; the daily capture tools (find-active-tab, screenshare-mask,
// attach-coding) returned to the visible toolbar, and the per-site
// no-capture toggles live on the lamp strip's control center. Dismisses
